  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-aurora': 'linear-gradient(135deg, hsl(var(--aurora-green)) 0%, hsl(var(--nebula-blue)) 100%)',
        'gradient-solar': 'linear-gradient(135deg, hsl(var(--solar-orange)) 0%, hsl(var(--star-yellow)) 100%)',
